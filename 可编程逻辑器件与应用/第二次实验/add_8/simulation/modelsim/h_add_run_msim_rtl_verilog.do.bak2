...
vlog -vlog01compat -work work +incdir+E:/altera/15.0/Project/2020/h_add {E:/altera/15.0/Project/2020/h_add/h_add.v}

vlog -vlog01compat -work work +incdir+E:/altera/15.0/Project/2020/h_add/simulation/modelsim {E:/altera/15.0/Project/2020/h_add/simulation/modelsim/h_add.vt}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  h_add_vlg_tst
