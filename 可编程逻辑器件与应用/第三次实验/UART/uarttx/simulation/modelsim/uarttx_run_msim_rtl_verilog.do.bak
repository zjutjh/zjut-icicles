...
vlog -vlog01compat -work work +incdir+E:/altera/15.0/Project/2020/uarttx {E:/altera/15.0/Project/2020/uarttx/uarttx.v}

vlog -vlog01compat -work work +incdir+E:/altera/15.0/Project/2020/uarttx/simulation/modelsim {E:/altera/15.0/Project/2020/uarttx/simulation/modelsim/uarttx.vt}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  uarttx_vlg_tst
