...
vlog -vlog01compat -work work +incdir+E:/altera/15.0/Project/2020/uartrx {E:/altera/15.0/Project/2020/uartrx/uartrx.v}

vlog -vlog01compat -work work +incdir+E:/altera/15.0/Project/2020/uartrx/simulation/modelsim {E:/altera/15.0/Project/2020/uartrx/simulation/modelsim/uartrx.vt}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  uartrx_vlg_tst
