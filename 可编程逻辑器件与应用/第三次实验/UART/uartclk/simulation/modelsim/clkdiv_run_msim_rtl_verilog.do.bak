...
vlog -vlog01compat -work work +incdir+E:/altera/15.0/Project/2020/uartclk {E:/altera/15.0/Project/2020/uartclk/clkdiv.v}

vlog -vlog01compat -work work +incdir+E:/altera/15.0/Project/2020/uartclk/simulation/modelsim {E:/altera/15.0/Project/2020/uartclk/simulation/modelsim/clkdiv.vt}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  clkdiv_vlg_tst
