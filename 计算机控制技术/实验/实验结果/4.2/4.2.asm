...
TK DB 64H ;采样周期
K0 DB 00H,76H,50H ;系数K0的值为+0.7650
K1 DB 01H,73H,20H ;系数K1的值为-0.7320
K2 DB 00H,16H,51H ;系数K2的值为+0.1651
K3 DB 00H,00H,00H ;系数K3的值为0
P1 DB 01H,40H,80H ;系数P1的值为-0.4080
P2 DB 01H,59H,20H ;系数P2的值为-0.5920
