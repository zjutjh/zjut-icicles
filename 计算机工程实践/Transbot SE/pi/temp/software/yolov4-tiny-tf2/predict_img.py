...
def main():
    ...
    parser.add_argument('--model', type=str, default=os.path.join(current_dir, 'logs/last1.weights.h5'),
                        help='模型权重文件路径')
    parser.add_argument('--classes', type=str, default=os.path.join(current_dir, 'model_data/CampusBot.txt'),
                        help='类别名称文件路径')
    parser.add_argument('--anchors', type=str, default=os.path.join(current_dir, 'model_data/CampusBot_anchors.txt'),
                        help='锚框文件路径')
    ...
    parser.add_argument('--input_dir', type=str, default='',
                        help='输入图片目录，如果不指定则使用当前目录下的测试图片')
    parser.add_argument('--output_dir', type=str, default=os.path.join(current_dir, 'output_random'),
                        help='输出图片保存目录')
    ...
    if args.input_dir:
        ...
        images_to_test = [os.path.join(current_dir, img) for img in test_images]
